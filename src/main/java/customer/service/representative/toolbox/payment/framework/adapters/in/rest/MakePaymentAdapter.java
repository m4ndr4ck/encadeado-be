...
import customer.service.representative.toolbox.payment.application.useCases.MakePaymentUseCase.MakePaymentCommand;
...
public class MakePaymentAdapter {
    ...
    void makePayment(
            ...
            @PathVariable("invoiceId") Invoice.InvoiceId invoiceId) {
